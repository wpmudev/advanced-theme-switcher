	...
	class Advanced_Theme_Switcher {
		...
		function set_cookie() {
			...
			if ( is_multisite() && defined( 'SUBDOMAIN_INSTALL' ) && ! SUBDOMAIN_INSTALL ) {
				/*
				For multisite setups using subdirectories we need to set the cookiepath
				so the cookie doesn't affect ALL sites
				*/
				$blog        = get_blog_details();
				$cookie_path = $blog->path;
			}

			setcookie( 'advanced-theme-switcher-' . COOKIEHASH, stripslashes( $this->queried_theme ), $expire, $cookie_path );
		}
...
if ( ! class_exists( 'Advanced_Theme_Switcher_Widget' ) ) {
	class Advanced_Theme_Switcher_Widget extends WP_Widget {
		...
		function Advanced_Theme_Switcher_Widget() {
			...
			/* Create the widget. */
			$this->__construct( 'advanced-theme-switcher-widget', __( 'Advanced Theme Switcher Widget', 'advanced-theme-switcher' ), $widget_ops, $control_ops );
		}
		...
		function form( $instance ) {
            ...
            <p><label for="<?php echo $this->get_field_id( 'display_type' ); ?>"><?php
                ...
                <span><input type="radio" name="<?php echo $this->get_field_name( 'display_type' ); ?>"
                             value="list" <?php
            ...
            <p><label for="<?php echo $this->get_field_id( 'show_theme_parent' ); ?>"><?php
                ...
                <span><input type="radio" name="<?php echo $this->get_field_name( 'show_theme_parent' ); ?>"
                             value="yes" <?php
					if ( 'yes' == $show_theme_parent ) {
						echo ' checked="checked"';
					}
					?> /> <?php _e( 'Parent &amp; Child', 'advanced-theme-switcher' ); ?></span>
                <span><input type="radio" name="<?php echo $this->get_field_name( 'show_theme_parent' ); ?>"
                             value="no" <?php
					if ( 'no' == $show_theme_parent ) {
						echo ' checked="checked"';
					}
            ...
            <p><label for="<?php echo $this->get_field_id( 'show_theme_groups' ); ?>"><?php
                ...
                <span><input type="radio" name="<?php echo $this->get_field_name( 'show_theme_groups' ); ?>"
                             value="yes" <?php
					if ( 'yes' == $show_theme_groups ) {
						echo ' checked="checked"';
					}
					?> /> <?php _e( 'Yes', 'advanced-theme-switcher' ); ?></span>
                <span><input type="radio" name="<?php echo $this->get_field_name( 'show_theme_groups' ); ?>"
                             value="no" <?php
					if ( 'no' == $show_theme_groups ) {
						echo ' checked="checked"';
					}
            ...
            <p><label for="<?php echo $this->get_field_id( 'show_theme_parent_folder' ); ?>"><?php
                ...
                <span><input type="radio" name="<?php echo $this->get_field_name( 'show_theme_parent_folder' ); ?>"
                             value="yes" <?php
					if ( 'yes' == $show_theme_parent_folder ) {
						echo ' checked="checked"';
					}
					?> /> <?php _e( 'Yes', 'advanced-theme-switcher' ); ?></span>
                <span><input type="radio" name="<?php echo $this->get_field_name( 'show_theme_parent_folder' ); ?>"
                             value="no" <?php
					if ( 'no' == $show_theme_parent_folder ) {
						echo ' checked="checked"';
					}
					?>/> <?php _e( 'No', 'advanced-theme-switcher' ); ?></span>
            </p>
            ...
            <p><label for="<?php echo $this->get_field_id( 'show_theme_version' ); ?>"><?php
                ...
                <span><input type="radio" name="<?php echo $this->get_field_name( 'show_theme_version' ); ?>"
                             value="yes" <?php
					if ( 'yes' == $show_theme_version ) {
						echo ' checked="checked"';
					}
					?> /> <?php _e( 'Yes', 'advanced-theme-switcher' ); ?></span>
                <span><input type="radio" name="<?php echo $this->get_field_name( 'show_theme_version' ); ?>"
                             value="no" <?php
					if ( 'no' == $show_theme_version ) {
						echo ' checked="checked"';
					}
					?>/> <?php _e( 'No', 'advanced-theme-switcher' ); ?></span>
            </p>
